---
title: "The Prop Trader Tax Landscape Is Changing in 2026: What You Need to Know"
description: "Tax rules for prop traders are evolving in 2026 across the US, UK, and EU. Here's a breakdown of the key developments, trader classifications, and what to watch for."
pubDate: "2026-04-02"
category: "News"
tags: ["Tax", "Trader Taxation", "Prop Trader", "Financial Regulations"]
---
...
**1099-type income classification:**
Most US prop traders receive payouts that are treated as independent contractor income (reported on 1099-MISC or 1099-NEC by the paying firm). This means:
- Full self-employment tax applies (15.3% on net earnings up to the Social Security wage base)
- Deductible business expenses can offset this income (platform fees, education, home office, data subscriptions)
- Quarterly estimated tax payments are required to avoid underpayment penalties

**Mark-to-Market (MTM) election under Section 475:**
Prop traders who qualify as "traders in securities" under IRS rules can elect MTM accounting, which:
- Treats unrealized gains and losses as realized at year-end
- Converts capital gains/losses to ordinary income/losses
- Removes the $3,000 capital loss limitation
- Requires annual election by April 15 of the tax year
...
**The home office and expense angle:**
Regardless of 475 election status, prop traders can typically deduct legitimate business expenses:
- Platform and data subscription fees
- Challenge fees (business expense of generating income)
- Home office allocation (if trading is primary use)
- Educational courses and materials
- Tax and accounting fees related to the trading business
...
- Prop trading profits are typically treated as **income, not capital gains** for tax purposes — taxed at income tax rates
- If prop trading is a primary occupation, National Insurance contributions may apply
- UK traders receiving payments from offshore prop firms must self-report this income in the Self Assessment system
- The non-dom rules that historically allowed some offshore income deferral have been significantly curtailed
...
- Challenge fees paid to offshore firms may not include VAT that is technically owed in the trader's home country
- Some EU-based prop firms are beginning to include VAT on fees for EU residents
- Traders operating as registered businesses should ensure their challenge fee treatment is consistent with their jurisdiction's VAT rules

## The Broader Global Trend

Across jurisdictions, the directional movement in 2026 is consistent:

- **Tax authorities are forming views** on how prop trading income should be classified — and those views tend to favor income/self-employment characterizations over capital gains treatment
- **Reporting requirements are increasing** — more data is flowing between payment processors, prop firms, and tax authorities
- **The "I didn't know" defense** is becoming less viable — the information is accessible and the sums are material
