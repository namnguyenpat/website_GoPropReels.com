---
title: "Prop Firm Revenue Insights: What Q1 2026 Numbers Reveal About the Business Model"
description: "Q1 2026 revenue data reveals how prop firms actually make money, where the margins sit, and what the numbers mean for traders evaluating long-term firm viability."
pubDate: "2026-04-02"
category: "News"
tags: ["Revenue Analysis", "Business Model", "Prop Firm Economics", "Q1 2026"]
---
...
**Stream 1: Challenge/Evaluation Fees (Primary)**
This is the headline number most traders think about. A firm with 30,000 evaluation starts per month at an average fee of $150 generates $4.5 million in monthly gross revenue from fees alone.
...
**Stream 2: Monthly Account Maintenance (Subscription Models)**
Firms using subscription-based evaluation models (Topstep's Combine, some Apex tiers) generate recurring fee revenue independent of pass/fail outcomes. This creates more predictable revenue than pure challenge fee models.

**Stream 3: Spread and Execution Revenue**
Firms operating their own execution infrastructure retain a portion of the bid-ask spread on every trade placed by evaluation and funded account traders. This "invisible" revenue stream can be material at scale.
...
**Stream 5: Premium Upgrades and Add-Ons**
Scaling programs, account resets, drawdown add-ons, and premium plan upgrades represent growing revenue streams as firms develop their product suites.
...
1. **FTMO:** Estimated $35-45M Q1 revenue. Dominant position in forex challenge market with over a decade of brand building.
2. **Apex Trader Funding:** Estimated $25-35M Q1 revenue. Record evaluation volumes in March drove strong performance.
3. **FundedNext:** Estimated $15-20M Q1 revenue. Rapid growth, high-fee account tiers contributing disproportionately.
4. **Topstep:** Estimated $12-18M Q1 revenue. Subscription model provides baseline; activation fee removal may compress short-term revenue but drives volume.
5. **The5%ers:** Estimated $8-12M Q1 revenue. Premium positioning with lower volume, higher average transaction value.
