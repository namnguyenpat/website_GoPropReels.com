---
title: "Tax Guide for Prop Firm Traders in 2026 — What You Need to Know"
description: "Prop firm trading income has unique tax implications. This guide covers how payouts are classified, what deductions are available, and how to handle taxes in the US, UK, and beyond."
pubDate: "2026-04-02"
category: "Knowledge"
tags: ["prop firm taxes", "trading tax 2026", "funded trader income tax", "prop trading income", "self employed trader tax"]
---

## The Scene You Cannot Skip: Taxes

Every profitable prop trader eventually faces the same uncomfortable conversation with reality: the money is real, so the tax obligations are real too. This is not the most cinematic topic — but ignoring it can cost more than any drawdown violation ever will.
...
In most jurisdictions, prop firm payouts are treated as **business income** or **self-employment income** — not as capital gains. This is an important distinction because:

- **Capital gains** are often taxed at lower rates (long-term) and have specific qualifying rules
- **Business/self-employment income** is taxed at ordinary income rates and may be subject to self-employment tax
...
- **Self-employment income** if you are trading consistently as a business activity
- **Ordinary income** reported on Schedule C (self-employed) in most situations
- **Subject to self-employment tax** (approximately 15.3% on net earnings up to the Social Security wage base, 2.9% above)
...
- Trade on a substantial, regular, and continuous basis (courts have accepted 720+ trades per year as a benchmark)
- Seek to profit from short-term price movements (not investment)
- Have trading as a significant part of your livelihood

**TTS benefits:**
- Business expense deductions for platform fees, subscriptions, home office, education
- Potential Section 475 mark-to-market election (losses fully deductible as ordinary losses)

Consult a CPA who specializes in trader taxation — this classification has significant implications and should not be self-applied without professional guidance.
...
- **Trading income** — taxed as self-employment income at income tax rates plus National Insurance contributions
- **Investment income** — taxed under Capital Gains Tax rules
...
- Register as self-employed with HMRC if prop trading is a significant income source
- Expenses related to trading may be deductible
- Keep records of all transactions and payouts
- The annual Capital Gains Tax allowance may apply in some cases but is not typically the primary treatment
...
| Expense | Notes |
|---------|-------|
| Prop firm evaluation fees | Potentially deductible as business expense |
| Trading platform fees | Deductible |
| Data subscriptions (news, signals) | Deductible |
| Trading education courses | Typically deductible |
| Home office portion | Requires dedicated trading space |
| Computer/hardware | Potentially depreciable or deductible |
| Internet service (partial) | Deductible if used primarily for trading |
| Accounting/legal fees | Deductible |
| VPS hosting for automated strategies | Deductible |
...
- Track every payout in a spreadsheet with date, firm name, amount, and payment method
- Save all payout confirmations and tax documents from prop firms
- Keep records for at least 7 years (US IRS standard)
- Separate a business bank account for prop trading income
- Use accounting software (QuickBooks, Wave, FreeAgent) from day one
...
Tax compliance is not optional — but with the right structure, it is entirely manageable. Set aside a percentage of every payout the moment it arrives. Hire a CPA familiar with trader taxation. Keep detailed records from your very first funded month.
