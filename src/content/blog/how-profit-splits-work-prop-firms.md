---
title: "How Profit Splits Work at Prop Firms — Everything You Need to Know"
description: "Understand exactly how prop firm profit splits work in 2026. Learn payout structures, split percentages, scaling plans, and what actually ends up in your pocket."
pubDate: "2026-04-02"
category: "Knowledge"
tags: ["profit split", "prop firm payouts", "funded account earnings", "payout structure", "prop trading income"]
---

## Show Me the Money — How Profit Splits Actually Work

The headline reads "80% profit split" and it sounds incredible. You make $10,000 in a month, you keep $8,000. Simple, right?
...
This is your financial literacy scene — and it matters more than almost any technical analysis video you will ever watch.
...
|-----------|---------------------|
| Entry-level firm | 70–75% |
| Mid-tier firm | 80% |
| Premium/competitive firm | 85–90% |
| Elite/maximum | 90–95% |
...
- **Net profit** — your gross trading gains minus any applicable fees, commissions, or spreads
- **Profit share request** — when you formally request a payout from the firm
- **Profit split** — the agreed percentage you receive from net profit
- **Payout cycle** — how often you can request payouts (biweekly, monthly, on-demand)
- **Minimum payout threshold** — some firms require a minimum profit before you can withdraw
...
- Month's net profit: $2,000
- After fee: $2,000 − $150 = $1,850 eligible profit
...
Some firms allow you to request a payout at any time after a minimum holding period (often 5–10 trading days). This is the most flexible structure.

**Firms using this:** FTMO (after minimum trading days), FundedNext

### Structure 2: Biweekly/Monthly Scheduled Payouts

The firm processes payouts on a set schedule. You request during the window, receive within 1–5 business days.
...
**FTMO's path to 90%:** Achieve consistent performance, maintain minimum profit thresholds monthly, no violations — the split moves from 80% to 90% over time.
...
`Net Profit = Realized gains − Realized losses`

**It does not include:**
- Unrealized open positions (floating P&L)
- Spreads (these are already reflected in your realized gains/losses)
- Evaluation fees (these are not deducted from profit — they are a separate purchase)
...
## Profit Split vs Profit Share — Know the Difference

Some firms market "profit share from evaluation" — meaning they pay out a percentage of simulated profits during the challenge phase itself, not just the funded phase.

**FundedNext's Evaluation Profit Share:**
...
This is a marketing differentiator, not the primary income source — but it is a genuine benefit for profitable challenge traders.
...
|--------|------------------|-------------|
| Bank wire transfer | 2–5 business days | Most firms |
| Cryptocurrency (USDT, BTC) | 24–48 hours | FundedNext, The Funded Trader |
| Deel/Rise (payroll platforms) | 1–3 business days | FTMO, larger firms |
| PayPal | 1–2 business days | Some smaller firms |
| Wise | 1–3 business days | Varies |
...
| 3× $100K accounts | 5% = $15,000 | 80% | $12,000 |
